...
use /homes/nber/mauadr/bulk/orbis.work/intan_mp/data/dta/db_reg_orbis_npt_2yt_states.dta, clear //from orbis_create_db.do
egen bvdid_code = group(bvdidnumber)
xtset bvdid_code year

************************************************
* Lagged 2yT and intangibility classification
************************************************
...
save /homes/nber/mauadr/bulk/orbis.work/intan_mp/data/dta/db_reg_orbis_npt_2yt_states_complete.dta, replace
