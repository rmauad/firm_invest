...
model_tang = smf.ols('d_debt_at_adj ~ treated + post + treatment_post', data=df_tang_trim).fit()
model_intan = smf.ols('d_debt_at_adj ~ treated + post + treatment_post', data=df_intan).fit()
