...
df = df.assign(dummy_intan = (df['ter'] == 3).astype(int),
                dummy_tang = (df['ter'] == 1).astype(int))
...
X = df_treated[['log_emp', 'lagged_debt_at', 'dummy_tang']] # Include all control and dummy variables here
X['tang_Y_-2'] = df_treated['Y_-2']*df_treated['dummy_tang']
X['tang_Y_-1'] = df_treated['Y_-1']*df_treated['dummy_tang']
X['tang_Y_0'] = df_treated['Y_0']*df_treated['dummy_tang']
X['tang_Y_1'] = df_treated['Y_1']*df_treated['dummy_tang']
X['tang_Y_2'] = df_treated['Y_2']*df_treated['dummy_tang']
