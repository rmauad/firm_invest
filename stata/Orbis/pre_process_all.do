...
***********************************************************************
* Including data on equity (only run if including equity is necessary)
***********************************************************************

use bvdidnumber totalshareholdersequity using /homes/nber/mauadr/orbis.work/orbis4/bycnty/US/dfindusd.dta, clear
duplicates drop bvdidnumber, force
merge 1:m bvdidnumber using /homes/nber/mauadr/bulk/orbis.work/intan_mp/data/dta/db_reg_orbis_all_2yt_states_complete.dta, keep(3) nogen

save /homes/nber/mauadr/bulk/orbis.work/intan_mp/data/dta/db_reg_orbis_all_2yt_states_equity_complete.dta, replace
