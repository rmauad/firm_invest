...
# To run a Double Machine Learning Estimator, use a Lasso specification
...
feature_names = X.columns  # Adjust if X_scaled does not have column names directly
...
# Adding a column to indicate whether the coefficient is zero
coeff_df['Is Zero'] = coeff_df['Coefficient'].apply(lambda x: x == 0)
