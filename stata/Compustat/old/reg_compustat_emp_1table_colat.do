...
cap rename (d_treas_2y_lag1) (mpshock)
xtreg dln_emp c.mpshock##c.d_less_const ln_assets sales_growth_lag1 cash_at_lag1 dln_RGDP_lag1 d_Ind_prod_lag1 if med_low == 1,fe cluster(ff_indust)
est store emp_low
xtreg dln_emp c.mpshock##c.d_less_const ln_assets sales_growth_lag1 cash_at_lag1 dln_RGDP_lag1 d_Ind_prod_lag1 if med_high == 1,fe cluster(ff_indust)
est store emp_mid
xtreg dln_emp c.mpshock##c.d_less_const ln_assets sales_growth_lag1 cash_at_lag1 dln_RGDP_lag1 d_Ind_prod_lag1 if ter_high == 1,fe cluster(ff_indust)
est store emp_high
