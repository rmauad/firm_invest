...
replace u = _b[c.d_treas_2y_lag1] + _b[1.ter_bot#c.d_treas_2y_lag1] if _n == `h'+1
replace d = _b[c.d_treas_2y_lag1] + _b[1.ter_bot#c.d_treas_2y_lag1] if _n == `h'+1
eststo 
}
...
twoway ///
		...
		yline(-10(5)12, lcolor(gs13) lpattern(solid)) ///
		ylabel(-10(5)12, angle(horizontal) labsize(medlarge)) ///
		xlabel(-0(2)`h_cur', angle(horizontal) labsize(medlarge)) ///
		graphregion(color(white)) plotregion(color(white))
		
		graph export "output/graphs/tang_sel_states_inter.png", as(png) replace
...
replace b = _b[1.ter_top#c.d_treas_2y_lag1] + _b[1.ter_top#c.d_treas_2y_lag1] if _n == `h'+1
replace u = _b[1.ter_top#c.d_treas_2y_lag1] + _b[1.ter_top#c.d_treas_2y_lag1] if _n == `h'+1
replace d = _b[1.ter_top#c.d_treas_2y_lag1] + _b[1.ter_top#c.d_treas_2y_lag1] if _n == `h'+1
eststo 
}
//nois esttab , se nocons keep(L.dstir)
twoway ///
		...
		graph export "output/graphs/intang_sel_states_inter.png", as(png) replace
