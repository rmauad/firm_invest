...
twoway ///
		...
		ylabel(-3(1)2.5, angle(horizontal) labsize(medlarge)) ///
		xlabel(-0(2)`h_cur', angle(horizontal) labsize(medlarge)) ///
		graphregion(color(white)) plotregion(color(white))
		
		graph export "output/graphs/tang.png", as(png) replace
...
twoway ///
		...
		graph export "output/graphs/intang.png", as(png) replace
