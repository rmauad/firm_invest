...
replace ff_indust = 11 if ussicprimarycodes >= 6000 & ussicprimarycodes <= 6999
replace ff_indust = 12 if ff_indust ==.

keep if ff_indust != 11
...
merge 1:m bvdidnumber using /homes/nber/mauadr/bulk/orbis.work/intan_mp/data/dta/db_reg_orbis_2yt.dta, keep(2 3) 
gen stck_exc_ind = 0
