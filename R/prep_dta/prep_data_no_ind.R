...
db_reg_no_ind <- db_reg %>% group_by(GVKEY, year_q) %>% filter(row_number()==1) #keep just the first observation

# SAVING ####
#write.dta(db_reg, "data/dta/db_reg_2yt.dta")
save(db_reg_no_ind, file = "data/rdata/db_reg_2yt_no_ind.rdata")