...
xtreg dln_inv1  c.mpshock##ter_top ln_assets sales_growth_lag1 cash_at_lag1 i.year if d_less_const == 0 & year>=1997 & year<=2003,fe cluster(ff_indust)
xtreg dln_inv2  c.mpshock##ter_top ln_assets sales_growth_lag1 cash_at_lag1 i.year if d_less_const == 0 & year>=1997 & year<=2003,fe cluster(ff_indust)
xtreg dln_inv3  c.mpshock##ter_top ln_assets sales_growth_lag1 cash_at_lag1 i.year if d_less_const == 0 & year>=1997 & year<=2003,fe cluster(ff_indust)
xtreg dln_inv4  c.mpshock##ter_top ln_assets sales_growth_lag1 cash_at_lag1 i.year if d_less_const == 0 & year>=1997 & year<=2003,fe cluster(ff_indust)
xtreg dln_inv5  c.mpshock##ter_top ln_assets sales_growth_lag1 cash_at_lag1 i.year if d_less_const == 0 & year>=1997 & year<=2003,fe cluster(ff_indust)
xtreg dln_inv6  c.mpshock##ter_top ln_assets sales_growth_lag1 cash_at_lag1 i.year if d_less_const == 0 & year>=1997 & year<=2003,fe cluster(ff_indust)
xtreg dln_inv7  c.mpshock##ter_top ln_assets sales_growth_lag1 cash_at_lag1 i.year if d_less_const == 0 & year>=1997 & year<=2003,fe cluster(ff_indust)
xtreg dln_inv8  c.mpshock##ter_top ln_assets sales_growth_lag1 cash_at_lag1 i.year if d_less_const == 0 & year>=1997 & year<=2003,fe cluster(ff_indust)
...
xtreg dln_inv1  c.d_treas_2y_lag1 ln_assets sales_growth_lag1 cash_at_lag1 i.year if ter_bot == 1,fe cluster(ff_indust)
