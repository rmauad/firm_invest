...
gen d=0
qui forv h = 1/`h_cur' {
xtreg dln_inv`h' c.d_treas_2y_lag1##ter_bot ln_assets sales_growth_lag1 cash_at_lag1 i.year,fe cluster(ff_indust)
...
replace u = _b[c.d_treas_2y_lag1] + _b[1.ter_top#c.d_treas_2y_lag1] if _n == `h'+1
replace d = _b[c.d_treas_2y_lag1] + _b[1.ter_top#c.d_treas_2y_lag1] if _n == `h'+1
eststo 
}
//nois esttab , se nocons keep(L.dstir)
local h_cur 12
