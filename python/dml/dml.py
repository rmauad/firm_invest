...
# to estimate intangible capital from firm characteristice. Then, use this new intangible 
...
X = df_clean[['log_assets_lag1', 'log_assets_squared_lag1', 'sales_growth_lag1', 'debt_at_lag1', 'cash_at_lag1' ]]
y = df_clean['intan_at']
