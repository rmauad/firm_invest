...
save /homes/nber/mauadr/bulk/orbis.work/intan_mp/data/dta/intan_incomp2.dta, replace
...
save /homes/nber/mauadr/bulk/orbis.work/intan_mp/data/dta/db_reg_orbis_2yt_intan_at_all_measures.dta, replace

// Selecting non-publicly traded firms
use bvdidnumber stockexchangeslisted using exchanges.dta
duplicates drop bvdidnumber, force
merge 1:m bvdidnumber using /homes/nber/mauadr/bulk/orbis.work/intan_mp/data/dta/db_reg_orbis_2yt_intan_at_all_measures.dta, keep(2) //keep (2) preserves the observations from b_reg_orbis.dta that did not have an equivalent in exchanges.dta
save /homes/nber/mauadr/bulk/orbis.work/intan_mp/data/dta/db_reg_orbis_npt_2yt_intan_at_all_measures.dta, replace
