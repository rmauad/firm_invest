...
use year bvdidnumber cashequivalentsatendofyear using cfnusindusd.dta
egen bvdid_year = concat(bvdidnumber year), punct(_)
duplicates drop bvdid_year, force	
merge 1:1 bvdid_year using /homes/nber/mauadr/bulk/orbis.work/intan_mp/data/dta/intan.dta, keep(3) nogen
save /homes/nber/mauadr/bulk/orbis.work/intan_mp/data/dta/intan_cash.dta, replace
	
use year bvdidnumber capitalexpenditures purchaseacquisitionofintangibles using cfusindusd.dta
egen bvdid_year = concat(bvdidnumber year), punct(_)
duplicates drop bvdid_year, force
merge 1:1 bvdid_year using /homes/nber/mauadr/bulk/orbis.work/intan_mp/data/dta/intan_cash.dta, keep(3) nogen
...
save /homes/nber/mauadr/bulk/orbis.work/intan_mp/data/dta/intan_comp_2yt.dta, replace
// Merging databases
...
duplicates drop bvdidnumber, force
merge 1:m bvdidnumber using /homes/nber/mauadr/bulk/orbis.work/intan_mp/data/dta/db_reg_orbis_2yt.dta, keep(2) //keep (2) preserves the observations from b_reg_orbis.dta that did not have an equivalent in exchanges.dta
save /homes/nber/mauadr/bulk/orbis.work/intan_mp/data/dta/db_reg_orbis_npt_2yt.dta, replace
