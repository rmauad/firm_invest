...
// gen d_colat = 1 if (stateorprovinceinusorcanada == "TX" | stateorprovinceinusorcanada == "LA") & (year >= 1997 & year <= 2003)
// replace d_colat = 1 if stateorprovinceinusorcanada == "AL" & (year >= 2001 & year <= 2003)
// gen d_year_colat = 1 if (year >= 1997 & year <= 2003)
