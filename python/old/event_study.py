...
plt.figure(figsize=(12, 6))
sns.boxplot(x='year', y='debt_issuance', hue = 'category', data=df_year_filtered)
plt.title('Debt Issuance by Firm type and Year')
plt.xlabel('Years')
plt.ylabel('Debt Issuance (million $)')
plt.show()
...
X = df_tang_treated[['eq_at','Q_-8', 'Q_-7', 'Q_-6', 'Q_-5', 'Q_-4', 'Q_-3', 'Q_-2', 'Q_-1', 'Q_0',
...
X_intan = df_intan_treated[['eq_at','Q_-8', 'Q_-7', 'Q_-6', 'Q_-5', 'Q_-4', 'Q_-3', 'Q_-2', 'Q_-1', 'Q_0',
             'Q_1', 'Q_2', 'Q_3', 'Q_4', 'Q_5', 'Q_6', 'Q_7', 'Q_8']] # Include all control and dummy variables here
