...
twoway ///
		...
		yline(-2(1)4, lcolor(gs13) lpattern(solid)) ///
		ylabel(-2(1)4, angle(horizontal) labsize(medlarge)) ///
		xlabel(-0(2)8, angle(horizontal) labsize(medlarge)) ///
		graphregion(color(white)) plotregion(color(white))
		
		graph export "output/graphs/tang_other_states.png", as(png) replace
...
twoway ///
		...
		graph export "output/graphs/intang_other_states.png", as(png) replace
