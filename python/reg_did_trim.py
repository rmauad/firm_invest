...
percentile_98 = df_tang['debt_issuance'].quantile(0.98)
df_tang_trim = df_tang[df_tang['debt_issuance'] < percentile_98]

# Create a dummy 'post' for periods after 1997:Q1
df_tang_trim['post'] = (df_tang_trim['year_q'] > '1997Q1').astype(int)
...
model_tang = smf.ols('debt_issuance ~ treated + post + treatment_post', data=df_tang_trim).fit()
